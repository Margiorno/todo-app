...
SELECT '11111111-1111-1111-1111-111111111111', 'Team A'
    WHERE NOT EXISTS (SELECT 1 FROM teams WHERE id = '11111111-1111-1111-1111-111111111111');

INSERT INTO teams (id, name)
SELECT '11111111-1111-1111-1111-111111111112', 'Team B'
    WHERE NOT EXISTS (SELECT 1 FROM teams WHERE id = '11111111-1111-1111-1111-111111111112');
...
-- CONVERSATION
INSERT INTO conversation (id, title, conversation_type)
SELECT '22222222-2222-2222-2222-222222222222', 'Project Discussion', 'GROUP_CHAT'
    WHERE NOT EXISTS (
    SELECT 1 FROM conversation WHERE id = '22222222-2222-2222-2222-222222222222'
);

INSERT INTO conversation (id, title, conversation_type)
SELECT '22222222-2222-2222-2222-222222222223', 'Team Meeting', 'GROUP_CHAT'
    WHERE NOT EXISTS (
